...
import {
  ...
  ScheduleComponent, DayService, WeekService, MonthService, AgendaService, ResizeService, PopupOpenEventArgs
...
export class TimetableComponent implements OnInit {
  ...
  onPopupOpen(args: PopupOpenEventArgs): void {
    ...
    if (!args.element.querySelector('.e-clientname')) {
      var row = this.ej.base.createElement('div', { className: 'e-clientname' });
      var formElement = args.element.querySelector('.e-schedule-form');
      formElement.firstChild.insertBefore(row, args.element.querySelector('.e-description-row'));
      var container = this.ej.base.createElement('div', { className: 'e-clientname-container' });
      var inputEle = this.ej.base.createElement('input', {
